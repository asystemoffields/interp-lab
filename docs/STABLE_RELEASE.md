...
- The browser app supports the core workflow for less-technical users: guided command setup, local job execution, run history, artifact browsing, report preview, graph preview, clear errors, and configuration export/import.
