...
COMMAND_SPECS: list[dict[str, Any]] = [
    {
        ...
        "fields": [
            ...
            {"key": "verbalizer", "flag": "--verbalizer", "label": "Verbalizer", "type": "select", "default": "toy", "options": ["toy", "nla"]},
            {"key": "nla_explanations", "flag": "--nla-explanations", "label": "NLA explanations", "placeholder": "reports/nla-explanations.jsonl"},
            {"key": "nla_min_confidence", "flag": "--nla-min-confidence", "label": "NLA min confidence", "type": "number"},
            {"key": "nla_no_fallback", "flag": "--nla-no-fallback", "label": "Disable verbalizer fallback", "type": "boolean"},
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "latent_dim", "flag": "--latent-dim", "label": "SAE latent dim", "type": "number"},
            ...
            {"key": "skip_prompt_pack", "flag": "--skip-prompt-pack", "label": "Use prompt dataset directly", "type": "boolean"},
    ...
    },
    {
        "id": "intervene",
        "group": "Causal",
        "label": "Intervene On Features",
        "description": "Amplify, suppress, or ablate selected hidden dimensions or SAE latents.",
        "fields": [
            {"key": "model", "flag": "--model", "label": "Model", "required": True},
            {"key": "dataset", "flag": "--dataset", "label": "Prompt Dataset", "required": True},
            ...
            {"key": "strength_sweep", "flag": "--strength-sweep", "label": "Strength sweep", "placeholder": "1,3,10"},
            {"key": "target_token", "flag": "--target-token", "label": "Target tokens", "type": "repeat"},
            {"key": "plan_out", "flag": "--plan-out", "label": "Plan JSON", "default": "reports/intervention-plan.json"},
            {"key": "dry_run", "flag": "--dry-run", "label": "Plan only", "type": "boolean", "default_checked": True},
            {"key": "json", "flag": "--json", "label": "Print JSON", "type": "boolean"},
            {"key": "device", "flag": "--device", "label": "Device", "default": "cpu"},
        ],
    },
    {
    ...
    {
        "id": "check-explanation-consistency",
        "group": "Explanation",
        "label": "Check Explanation Consistency",
        "description": "Compare shared feature explanations and ranks across paraphrased inspection reports.",
        "fields": [
            {"key": "report", "flag": "--report", "label": "Inspection reports", "type": "repeat", "required": True, "placeholder": "reports/inspection/report.json"},
            {"key": "out", "flag": "--out", "label": "Output JSON", "default": "reports/explanation-consistency.json"},
    ...
    },
    {
        ...
        "description": "Find features whose labels, examples, or explanations match a natural-language query.",
        "fields": [
            {"key": "report", "flag": "--report", "label": "Inspection reports", "type": "repeat", "required": True, "placeholder": "reports/inspection/report.json"},
            {"key": "query", "flag": "--query", "label": "Query", "required": True, "placeholder": "features that represent valid tool-call arguments"},
            {"key": "out", "flag": "--out", "label": "Output JSON", "default": "reports/feature-search.json"},
            {"key": "markdown_out", "flag": "--markdown-out", "label": "Markdown report", "default": "reports/feature-search.md"},
            {"key": "html_out", "flag": "--html-out", "label": "HTML report", "default": "reports/feature-search.html"},
            {"key": "top_k", "flag": "--top-k", "label": "Top K", "type": "number", "default": "10"},
            {"key": "min_score", "flag": "--min-score", "label": "Min score", "type": "number", "default": "0"},
        ],
    },
    {
        "id": "compare-model-families",
        "group": "Cross-Model",
        "label": "Compare Model Families",
        "description": "Summarize feature matches across reports grouped by model family.",
        "fields": [
            {"key": "member", "flag": "--member", "label": "Family/report members", "type": "repeat", "required": True, "placeholder": "gemma=reports/gemma/report.json"},
            {"key": "out", "flag": "--out", "label": "Output JSON", "default": "reports/model-family-comparison.json"},
            {"key": "markdown_out", "flag": "--markdown-out", "label": "Markdown report", "default": "reports/model-family-comparison.md"},
            {"key": "html_out", "flag": "--html-out", "label": "HTML report", "default": "reports/model-family-comparison.html"},
            {"key": "top_k", "flag": "--top-k", "label": "Top K", "type": "number", "default": "5"},
            {"key": "min_score", "flag": "--min-score", "label": "Strong match threshold", "type": "number", "default": "0.65"},
        ],
    },
    {
        "id": "match-text-pivot",
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "negative_prompt", "flag": "--negative-prompt", "label": "Inline negative prompts", "type": "repeat"},
            {"key": "latent_dim", "flag": "--latent-dim", "label": "SAE latent dim", "type": "number"},
            {"key": "include_causal", "flag": "--include-causal", "label": "Include causal eval", "type": "boolean"},
            {"key": "skip_prompt_pack", "flag": "--skip-prompt-pack", "label": "Use prompt dataset directly", "type": "boolean"},
        ],
    },
    {
